...
if (!isGeneric("plot.fom")) {
    setGeneric("plot.fom", function(x, ...)
               standardGeneric("plot.fom"))
}
...
#' @rdname plot.fom
#' @aliases plot.fom,FigureOfMerit-method
setMethod("plot.fom", signature(x = "FigureOfMerit"),
